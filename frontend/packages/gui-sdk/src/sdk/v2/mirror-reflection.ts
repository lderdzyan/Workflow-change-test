...
export const addTopicsFeelingWords = (data: IFeelingWordTopic): TE.TaskEither<RequestError, O.Option<EmptyResponse>> => doPost<EmptyResponse>(APIPathsV2.MirrorReflection.AddEditFeelingWordTopic, data);

export const getTopicsFeelingWords = (): TE.TaskEither<RequestError, O.Option<FeelingWordSTopicSGetResponse>> => doPost<FeelingWordSTopicSGetResponse>(APIPathsV2.MirrorReflection.GetFeelingWordTopic);
...
export const deleteMirrorReflectionById = (id: string): TE.TaskEither<RequestError, O.Option<EmptyResponse>> => doPost<EmptyResponse>(`${APIPathsV2.MirrorReflection.DeleteRefletionById}/${id}/delete`);
