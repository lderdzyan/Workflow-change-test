...
const AuthAllowedRoutes = [PATHS.AUTH.MWI_START, PATHS.AUTH.INDICATOR_START, PATHS.AUTH.BUILDER_START, PATHS.AUTH.SIGN_IN, PATHS.AUTH.RESET_PASSWORD, PATHS.AUTH.HOME];
